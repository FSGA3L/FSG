...
switch (_var) do
{
	...
	case "life_inv_tierope": {(localize "STR_Item_tierope")};
	...
	case "license_civ_gangciv": {(localize "STR_License_Gangs")};
	case "license_civ_blackwatch": {(localize "STR_License_blackwatch")};
	case "license_civ_warriors": {(localize "STR_License_warriors")};
	case "license_civ_rangers": {(localize "STR_License_rangers")};

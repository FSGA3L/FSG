...
switch (life_veh_shop select 0) do
{
	...
	case "civ_gs9": {_ret = license_civ_gs9;};
	case "civ_ocean": {_ret = license_civ_ocean;};
	case "civ_lsmo": {_ret = license_civ_lsmo;};
	case "civ_supporter1": {_ret = license_civ_Supporter50;};
	case "civ_supporter2": {_ret = license_civ_Supporter100;};
	case "civ_cadenunley": {_ret = license_civ_cadenunley;};
	...
	case "civ_gangciv": {_ret = license_civ_gangciv;};
	...
	case "cop_PD": {_ret = true;};
	case "cop_SWAT": {_ret = true;};
	case "cop_DOC": {_ret = true;};
	case "cop_IAnHR": {_ret = true;};
	case "cop_CID": {_ret = true;};
	case "cop_ship": 
	{

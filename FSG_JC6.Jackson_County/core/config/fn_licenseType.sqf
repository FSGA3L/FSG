...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "gangciv": {_var = "license_civ_gangciv"};
			case "blackwatch": {_var = "license_civ_blackwatch"};
			case "warriors": {_var = "license_civ_warriors"};
			case "rangers": {_var = "license_civ_rangers"};
			case "outlaws": {_var = "license_civ_outlaws"};
			case "disney": {_var = "license_civ_disney"};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_gangciv": {_var = "gangciv"};
			case "license_civ_blackwatch": {_var = "blackwatch"};
			case "license_civ_warriors": {_var = "warriors"};
			case "license_civ_rangers": {_var = "rangers"};
